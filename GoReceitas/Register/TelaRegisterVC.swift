...
class TelaRegisterVC: UIViewController {
    ...
    @IBOutlet weak var logoFundoImage: UIImageView!
    ...
    func configCaracteres(){
        ...
        cadastrarLabel.font = UIFont.systemFont(ofSize: 30, weight: .semibold)
        ...
        logoFundoImage.image = UIImage(named: "logoFundo")
